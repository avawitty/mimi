...
export const EditorialSpread: React.FC<EditorialSpreadProps> = ({ article, onClose }) => {
 ...
 animate={{ opacity: 1 }} 
 exit={{ opacity: 0 }}
 className="fixed inset-0 z-[9000] bg dark:bg flex flex-col font-serif text-stone-900 dark:text-stone-100"
 >
 {/* DOT GRID BACKGROUND */}
 ...
 {/* SIDEBAR METADATA */}
 <aside className="fixed left-0 top-0 h-full w-12 md:w-16 border-r border-stone-200 dark:border-stone-800 flex flex-col items-center py-8 z-50 bg/80 dark:bg/80 backdrop-blur-sm">
 ...
 <div className="w-1 h-1 bg-stone-500 rounded-none"></div>
 <span>δ: 0.12mm</span>
 </div>
 </div>
 </div>
 ...
 {/* NAV */}
 <nav className="sticky top-0 w-full z-40 border-b border-stone-200 dark:border-stone-800 bg/90 dark:bg/90 backdrop-blur px-8 py-4 ml-12 md:ml-16">
 <div className="max-w-7xl mx-auto flex justify-between items-center font-mono text-[10px] uppercase tracking-[0.2em]">
 <button onClick={onClose} className="flex items-center gap-2 hover:text-stone-600 transition-colors">
 ...
 <div className="p-8 rounded-none border border-stone-300 dark:border-stone-700">
...
"{article.subtitle}"
 ...
 <span className="text-stone-600 dark:text-stone-400">0{i+1}.</span> {section.domain ||"SECTION"}
 </h3>
 ...
 {mod.bestPractice && (
 <div className="mt-4 p-4 bg-stone-100 dark:bg-stone-900 border-l-2 border-stone-500">
 <span className="font-mono text-[9px] uppercase tracking-widest font-bold block mb-1 text-stone-600 dark:text-stone-400">Protocol:</span>
 ...
 <div className="bg dark:bg p-8 relative transform rotate-1 border border-stone-200 dark:border-stone-800">
...
"The hardest part of modern creativity is the premature optimization of the void."
 ...
 <div className="absolute -top-3 left-1/4 w-12 h-6 bg-stone-200/50 dark:bg-stone-800/50 backdrop-blur rotate-12 z-20"></div>
 <div className="bg-white dark:bg-stone-900 p-4 pb-12 -rotate-2 relative z-10 border border-stone-100 dark:border-stone-800">
 ...
 <span>Vector Space</span> <span className="text-stone-600">Active</span>
 </li>
 <li className="flex justify-between border-b border-dotted border-stone-400 pb-2">

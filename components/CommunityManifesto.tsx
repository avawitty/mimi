...
export const CommunityManifesto: React.FC = () => {
 ...
 <p className="font-serif italic text-xl text-nous-text0 max-w-2xl mx-auto leading-relaxed">
 ...
 <h2 className="font-sans text-xs uppercase tracking-[0.3em] font-black text-nous-text0">Brand Pillars</h2>
 </div>
 ...
 <h2 className="font-sans text-xs uppercase tracking-[0.3em] font-black text-nous-text0">Editorial Standards</h2>
 </div>
 ...
 <h2 className="font-sans text-xs uppercase tracking-[0.3em] font-black text-nous-text0">The Circle (Beta)</h2>
 </div>

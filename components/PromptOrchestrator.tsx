    ...
    const handleGenerateImage = async (prompt: any) => {
        ...
        try {
            ...
            if (base64) {
                ...
                await addToPocket(user?.uid || 'ghost', 'image', newItem);
        ...
        <div className="flex flex-col gap-6 w-full">
            <div className="space-y-2">
                ...
                <textarea
                    ...
                    className="w-full bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-sm p-3 text-sm font-mono text-stone-900 dark:text-stone-100 placeholder:text-stone-400 outline-none focus:border-primary dark:focus:border-stone-600 resize-none h-24"
                />
                <button
            ...
            {prompts.length > 0 && (
                <div className="space-y-6 mt-4">
                    ...
                    {prompts.map((p, i) => (
                        <div key={p.id || i} className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 p-4 rounded-sm space-y-3 relative group">
                            ...
                            <div className="bg-stone-50 dark:bg-stone-950 p-2 rounded-sm border border-stone-100 dark:border-stone-800">

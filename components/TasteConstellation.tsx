...
const DraggableArtifact: React.FC<{ artifact: PocketItem }> = ({ artifact }) => {
 ...
 <div
 ref={drag as any}
 className={`p-3 bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-none cursor-grab active:cursor-grabbing flex items-start gap-3 transition-opacity ${isDragging ? 'opacity-50' : 'opacity-100'}`}
 >
...
const ConstellationDropZone: React.FC<{
 ...
 isOver ? 'border-stone-500 bg-stone-500/5' : 'border-stone-200 dark:border-stone-800 bg-white/50 dark:bg-stone-900/50'
 }`}
 >
 ...
 className="p-3 bg-stone-100 dark:bg-stone-950 border border-stone-200 dark:border-stone-800 rounded-none flex justify-between items-center group"
 >
 ...
 className="w-full py-2 bg-stone-900 dark:bg-stone-100 text-stone-100 dark:text-stone-900 rounded-none font-sans text-xs uppercase tracking-widest hover:bg-stone-800 dark:hover:bg-stone-200 transition-colors"
 >
...
export const TasteConstellation: React.FC = () => {
 ...
 <div className="flex-1 flex h-full bg dark:bg text-stone-900 dark:text-stone-100 overflow-hidden">
 ...
 className="flex items-center gap-2 px-6 py-3 bg-stone-900 dark:bg-stone-100 text-white dark:text-black rounded-none hover:bg-stone-800 dark:hover:bg-stone-200 transition-colors font-sans text-[10px] uppercase tracking-widest"
 >
 <Plus size={14} />
 New Constellation
 </button>

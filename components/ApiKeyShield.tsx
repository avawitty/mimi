...
export const ApiKeyShield: React.FC<{ isOpen: boolean; onClose: () => void }> = ({ isOpen, onClose = () => {} }) => {
 ...
 <div className="w-24 h-24 border border-stone-200 dark:border-stone-800 rounded-none flex items-center justify-center mx-auto relative group">
 ...
 className="w-full py-4 border border-stone-100 dark:border-stone-800 rounded-none font-sans text-[9px] uppercase tracking-widest font-black text-stone-400 hover:text-nous-text dark:hover:text-white transition-all flex items-center justify-center gap-3"
 >

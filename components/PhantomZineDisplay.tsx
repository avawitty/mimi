...
export const PhantomZineDisplay: React.FC<PhantomZineDisplayProps> = ({ page, profile }) => {
  ...
  return (
    ...
    <div 
      className="relative w-full h-full bg-stone-900/50 backdrop-blur-xl border border-white/10 overflow-hidden rounded-xl shadow-2xl flex items-center justify-center p-8"
      style={{ 
    ...
    >
      <div className="relative w-full max-w-2xl aspect-[3/4] bg-white shadow-2xl" style={{ backgroundColor: 'var(--zine-base-color)' }}>
              ...
              <div className="relative w-full h-full group">
                ...
                {el.aestheticViolation?.isViolation && (
                  <motion.button 
                    ...
                    className="absolute bottom-2 left-1/2 -translate-x-1/2 bg-stone-900/90 text-white px-3 py-1.5 rounded-full text-[8px] uppercase tracking-widest font-black flex items-center gap-2 backdrop-blur-sm border border-stone-700 hover:bg-stone-800 transition-colors opacity-0 group-hover:opacity-100"
                  >

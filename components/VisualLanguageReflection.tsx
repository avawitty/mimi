...
export const VisualLanguageReflection: React.FC<{ 
 ...
 <Target size={20} className="text-stone-500"/>
 <h2 className="font-sans text-[10px] uppercase tracking-[0.3em] font-black text-stone-600">Visual Language Reflection</h2>
 </div>
 ...
 {archivalRedirects && (
 <div className="border border-stone-200 dark:border-stone-800 p-6 flex items-center gap-3 text-stone-600">
 <FileText size={16} />

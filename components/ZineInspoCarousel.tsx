...
export const ZineInspoCarousel: React.FC = () => {
 ...
 <div className="w-full h-24 bg-stone-200 dark:bg-stone-800 rounded-none overflow-hidden flex items-center justify-center">
 {isGeneratingImage ? (
 ...
 <p className="italic text-stone-600 dark:text-stone-400 text-xs truncate">{signature.primaryAxis}</p>
 </div>
 <div>
 ...
 <div className="absolute w-2 h-2 bg-stone-500 rounded-none top-1/4 left-1/4"></div>
 ...
 className={`w-1.5 h-1.5 rounded-none transition-colors ${activeView === idx ? 'bg-stone-800 dark:bg-stone-200' : 'bg-stone-300 dark:bg-stone-700'}`}
 />
 ))}
 </div>
 </div>

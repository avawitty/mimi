...
export const IntrovertaLabel: React.FC<{ onClick?: () => void }> = ({ onClick }) => {
  return (
    <motion.div 
      className="cursor-pointer w-64 shadow-xl rounded-[24px] overflow-hidden border border-stone-200 hover:shadow-2xl transition-shadow bg-[#f7f3ee]"
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" width="100%" height="100%" style={{ backgroundColor: '#f7f3ee' }}>
        <defs>
            <style>
                ...
                .brand-shadow { font-family: 'Fredoka', sans-serif; font-size: 64px; font-weight: 600; fill: #ffd6e0; letter-spacing: 2px; }
        ...
        <rect x="40" y="40" width="720" height="520" rx="30" fill="#ffffff" filter="url(#shadow)"/>
        ...
        <g transform="translate(70, 180)">
            <text x="3" y="3" className="brand-shadow">INTROVERTA</text>

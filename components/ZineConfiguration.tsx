...
export const ZineConfiguration: React.FC<ZineConfigurationProps> = ({ zineOptions, setZineOptions, profile, onSelectPrompt }) => {
 ...
 >
 <div>
 <p className={`font-sans text-xs uppercase tracking-widest ${!zineOptions.selectedTreatmentId ? 'text-primary dark:text-white font-bold' : 'text-nous-text0'}`}>Default / Manual</p>
 ...
 className="bg-transparent border-b border-primary/20 /20 text-sm font-sans text-primary dark:text-white focus:outline-none focus:border-primary dark:focus:border-white pb-2 cursor-pointer"
 >
 ...
 className="bg-transparent border-b border-primary/20 /20 text-sm font-sans text-primary dark:text-white focus:outline-none focus:border-primary dark:focus:border-white pb-2 w-full"
 />
 </div>
 </div>
 </div>
 ...
 className="text-[10px] uppercase tracking-[0.1em] px-3 py-1.5 border border-primary/20 /20 text-primary dark:text-white hover:bg-primary hover:text-white dark:hover:bg-white dark:hover:text-primary transition-colors"
 >
 {p.label}
 </button>
 ))}

...
export const ProsceniumView: React.FC<ProsceniumViewProps> = ({ onSelectZine }) => {
 ...
 return (
 <div className="flex-1 w-full h-full overflow-y-auto no-scrollbar bg-nous-base dark:bg text-nous-text dark:text-white transition-all duration-1000 relative">
 
 <div className="max-w-7xl mx-auto pt-20 px-6 md:px-12 pb-32">
 <header className="mb-16 space-y-6 text-center">
 <div className={`inline-flex items-center gap-2 px-4 py-1 rounded-none border font-sans text-[9px] uppercase tracking-[0.3em] font-black ${isOfflineMode ? 'border-stone-500/30 text-stone-500' : 'border-stone-500/30 text-stone-500'}`}>
 ...
 className={`font-sans text-[10px] uppercase tracking-[0.2em] font-black pb-4 transition-all ${activeChannel === 'global' ? 'text-nous-text dark:text-white border-b-2 border-nous-text dark:border-white' : 'text-stone-400 hover:text-stone-800 dark:hover:text-stone-300'}`}
 >
 Global Exhibition
 </button>
 {user && (
 ...
 className={`font-sans text-[10px] uppercase tracking-[0.2em] font-black pb-4 transition-all ${activeChannel === 'following' ? 'text-nous-text dark:text-white border-b-2 border-nous-text dark:border-white' : 'text-stone-400 hover:text-stone-800 dark:hover:text-stone-300'}`}
 >
 Following
 </button>
 )}
 ...
 className="group relative aspect-[3/4] bg-stone-100 dark:bg-stone-900 overflow-hidden cursor-pointer border border-stone-200 dark:border-stone-800 hover: transition-all duration-500"
 >
 {/* Visual Artifact */}
 {t.imageUrl ? (
 ...
 <div className={`w-1.5 h-1.5 rounded-none ${t.type === 'signal' ? 'bg-stone-500' : t.type === 'manifest' ? 'bg-indigo-500' : 'bg-stone-400'}`} />
 <button 
 ...
 <button onClick={(e) => handleWitness(t.id, e)} className="flex items-center gap-1.5 hover:text-stone-400 transition-colors">
 ...
 className="font-sans text-[8px] uppercase tracking-widest font-black text-white hover:text-stone-400 transition-colors"
 >
 ABSORB TRANSMISSION
 </button>
 ...
 <div className={`w-2 h-2 rounded-none ${selectedArtifact.type === 'signal' ? 'bg-stone-500' : 'bg-indigo-500'}`} />
 <button 
 ...
 className="font-sans text-[8px] uppercase tracking-widest font-black text-stone-500 hover:text-stone-400 transition-colors"
 >
 {note.userHandle}
 </button>
 ...
 className="flex-1 bg-white/5 border border-white/10 rounded-none px-4 py-3 font-serif italic text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-stone-800 dark:focus:border-stone-300/50 transition-colors"
 />
 <button 
 onClick={handleAddVibeNote}
 disabled={isSubmittingVibe || !newVibeNote.trim()}
 className="px-4 bg-stone-500/10 text-stone-500 border border-stone-500/30 hover:bg-stone-500/20 disabled:opacity-50 transition-colors flex items-center justify-center"
 >

        ...
        <div className="p-8">
            ...
            <div className="flex gap-4 mt-4">
                <button 
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-stone-100 rounded-md"
                >
                    <Share2 size={16}/> Share
                </button>
                <button className="flex items-center gap-2 px-4 py-2 bg-stone-100 rounded-md"><Edit2 size={16}/> Edit</button>
                <button 
                    onClick={() => {
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-red-100 text-red-600 rounded-md"
                >

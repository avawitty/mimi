        ...
        {phase !== 'tearing' && (
          <>
            ...
            <motion.div
              ...
              className="absolute top-0 left-0 right-0 h-1/2 bg-stone-50 dark:bg-stone-950 overflow-hidden origin-bottom"
            >
            ...
            <motion.div
              ...
              exit={{ y: '100vh', opacity: 0 }}
              transition={{ duration: 0.8, ease: [0.76, 0, 0.24, 1] }}
              className="absolute bottom-0 left-0 right-0 h-1/2 bg-stone-50 dark:bg-stone-950 overflow-hidden origin-top"
            >

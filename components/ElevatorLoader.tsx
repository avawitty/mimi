...
export const ElevatorLoader: React.FC<ElevatorLoaderProps> = ({ onComplete, onBypass, isDeep, loadingMessage, minDuration = 0 }) => {
 ...
 {/* Depth Fader at Top */}
 <div className="absolute top-0 inset-x-0 h-32 bg-gradient-to-b from dark:from to-transparent z-20 pointer-events-none"/>
 </div>

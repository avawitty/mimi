...
export const TitleLegend: React.FC = () => {
 ...
 >
 <div className="bg-white/95 dark:bg-stone-900/95 backdrop-blur-2xl border border-black/5 dark:border-white/10 p-5 rounded-none flex flex-col gap-4 overflow-hidden relative group/legend">
 ...
 <div className="w-2 h-2 rounded-none bg-stone-500"/>
 <div className="flex flex-col">
 <span className="font-sans text-[7px] uppercase tracking-widest font-black text-stone-600 dark:text-stone-400">Sovereign Authority</span>

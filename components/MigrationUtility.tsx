  ...
  return (
    <div className="p-6 bg-stone-50 border border-stone-200 rounded-sm space-y-4">
      ...
      <button 
        ...
        className="px-4 py-2 bg-nous-text text-white rounded-full text-xs uppercase tracking-widest font-black"
      >
        {isMigrating ? 'Migrating...' : 'Start Migration'}
      </button>
      <div className="grid grid-cols-2 gap-2 text-xs">
        {COLLECTIONS.map(c => (
          <div key={c} className="p-2 bg-white border border-stone-100 rounded">

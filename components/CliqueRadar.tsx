  ...
  return (
    <div className="w-full h-full flex flex-col overflow-y-auto no-scrollbar relative bg-nous-base dark:bg-stone-950 transition-colors duration-1000">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-[0.03] flex items-center justify-center overflow-hidden">
            <motion.div animate={{ rotate: 360 }} transition={{ duration: 60, repeat: Infinity, ease: 'linear' }} className="border-[0.5px] border-stone-900 dark:border-white w-[1200px] h-[1200px] rounded-full flex items-center justify-center">
        ...
        <div className="fixed bottom-0 left-0 w-full z-[100] border-t border-stone-100 dark:border-stone-800 bg-white/95 dark:bg-black/95 backdrop-blur-3xl px-12 py-10 flex justify-between items-center">
            <div className="flex items-center gap-6">
                ...
                <div className="space-y-1">
                    ...
                    <div className="w-64 h-1 bg-stone-100 dark:bg-stone-900 rounded-full overflow-hidden">
                        <motion.div animate={{ width: `${syncLevel}%` }} className="h-full bg-emerald-500" />
                    </div>
                </div>
            </div>

...
export const MimiGateway: React.FC<MimiGatewayProps> = ({ 
  ...
  return (
    <div className="min-h-[80vh] bg-[#F9F7F2] font-['Inter',sans-serif] text-[#1A1A1A] flex items-center justify-center p-4 md:p-8 selection:bg-black selection:text-white">

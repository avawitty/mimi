...
export const MimiGateway: React.FC<MimiGatewayProps> = ({ isOpen, onClose }) => {
 ...
 <h2 className="font-serif italic text-4xl text-stone-900 dark:text-white mb-2">Mimi Gateway</h2>
 <p className="font-sans text-[10px] uppercase tracking-widest text-stone-500">Anchor your identity</p>
 </div>

 {error && (
 <div className="mb-6 p-3 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 text-xs rounded-none text-center">
 {error}
 </div>
 )}
 ...
 <div>
 <label className="block font-sans text-[10px] uppercase tracking-widest text-stone-500 mb-2">Email Address</label>
 <input
 type="email"
 value={email}
 ...
 <div>
 <label className="block font-sans text-[10px] uppercase tracking-widest text-stone-500 mb-2">Password</label>
 <input
 type="password"
 value={password}

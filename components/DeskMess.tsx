    ...
    <>
      ...
      >
        ...
        <motion.div 
          ...
          className="absolute bottom-2 right-10 w-16 h-16 bg-[#fdf5c9] rounded-br-lg shadow-sm cursor-grab active:cursor-grabbing z-10"
          style={{ rotate: -15 }}
        />
        <motion.div 
          drag 
          dragMomentum={false}
          whileDrag={{ scale: 1.05, zIndex: 100, boxShadow: "5px 8px 15px rgba(0,0,0,0.2)" }}
          className="absolute bottom-8 right-2 w-24 h-16 bg-[#fffdf9] border border-[#ececec] rounded-sm shadow-sm cursor-grab active:cursor-grabbing z-20"
          style={{ rotate: 8 }}
        />
        <motion.div 
          drag 
          dragMomentum={false}
          whileDrag={{ scale: 1.05, zIndex: 100, boxShadow: "5px 8px 15px rgba(0,0,0,0.2)" }}
          className="absolute bottom-4 right-6 w-20 h-20 bg-[#ff8fab] rounded-md shadow-sm cursor-grab active:cursor-grabbing z-30"
          style={{ 
            rotate: 45,
        ...
        <motion.div 
          ...
          dragMomentum={false}
          whileDrag={{ scale: 1.05, zIndex: 100, boxShadow: "5px 8px 15px rgba(0,0,0,0.2)" }}
          className="absolute bottom-0 right-0 w-28 h-20 bg-[#e8f3f1] border border-[#ececec] rounded-sm shadow-sm cursor-grab active:cursor-grabbing z-40"
          style={{ rotate: -5 }}
        />
      </motion.div>
      ...
      <AnimatePresence>
        {showMuse && (
          <motion.div 
            ...
            className="fixed inset-0 bg-[#f4f3f0]/95 flex flex-col items-center justify-center z-[999] cursor-pointer"
            onClick={handleCloseMuse}
          >
            <div className="text-6xl mb-6">🎭</div>
            <div className="font-mono text-sm text-[#4a4a4a] max-w-md text-center leading-relaxed">

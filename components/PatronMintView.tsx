...
export const PatronMintView: React.FC<{ onExit: () => void }> = ({ onExit }) => {
  ...
  return (
    <div className="fixed inset-0 z-[20000] bg-[#FDFBF7] dark:bg-[#050505] flex flex-col items-center justify-center p-8 transition-colors duration-1000">
        ...
        {step === 'forging' && (
          ...
          >
            <div className="relative">
               <div className="absolute inset-0 border-t-2 border-amber-500 rounded-full animate-[spin_2s_linear_infinite]" />
               <div className="w-24 h-24 border border-stone-200 dark:border-stone-800 rounded-full flex items-center justify-center">
        ...
        {step === 'minted' && (
          ...
          >
             <div className="space-y-4">
                <div className="w-16 h-16 bg-amber-500 text-white rounded-full flex items-center justify-center mx-auto shadow-2xl mb-6">
                    <Key size={32} />
                </div>
             ...
             <div className="p-8 bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-sm shadow-xl relative overflow-hidden group">
                ...
                <div className="flex justify-center mt-6">
                    <button 
                        onClick={handleCopy}
                        className="flex items-center gap-2 px-4 py-2 bg-stone-100 dark:bg-stone-800 rounded-full font-sans text-[8px] uppercase tracking-widest font-black text-stone-500 hover:text-amber-500 transition-colors"
                    >
             ...
             <div className="space-y-4">
                ...
                <button 
                    ...
                    className="w-full py-5 bg-nous-text dark:bg-white text-white dark:text-black rounded-full font-sans text-[10px] uppercase tracking-[0.4em] font-black shadow-2xl hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-4"
                >
